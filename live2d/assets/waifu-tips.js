...
//看板娘样式设置
live2d_settings['waifuSize']            = '245x215';    // 看板娘大小，例如 '280x250', '600x535'
live2d_settings['waifuTipsSize']        = '190x70';     // 提示框大小，例如 '250x70', '570x150'
...
live2d_settings['waifuEdgeSide']        = 'right:90';     // 看板娘贴边方向，例如 'left:0'(靠左 0px), 'right:30'(靠右 30px)
...
live2d_settings['homePageUrl']          = 'https://aienh.github.io/';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://aienh.github.io/';   // 关于页地址, '{URL 网址}'
